        ...
        >
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-6">
              <li>You may cancel your monthly subscription at any time. Cancellation takes effect at the end of your current billing cycle.</li>
              <li>No refunds are issued for partial months. You will retain access to paid features until the end of the billing period.</li>
              <li>If you cancel within 7 days of your first paid subscription (new customers only) and have used the product for fewer than 3 events, bookings, or invoices (as applicable), you are eligible for a full refund. This is a one-time offer per account.</li>
            </ul>

            <h3 className="text-xl font-semibold text-text mb-3">2.3 Annual Subscriptions</h3>
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-6">
              <li>Annual subscriptions include a 14-day full refund window from the date of first payment.</li>
              <li>After 14 days, annual subscriptions are non-refundable. However, you may cancel at any time, and your plan will remain active until the end of the annual term.</li>
              <li>Switching from annual to monthly billing mid-term is not permitted. You must wait until your annual term expires.</li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-4">
              <li><strong>Discovery &amp; Strategy Phase (Week 1–2):</strong> If you choose to disengage after the discovery phase but before design begins, you may be entitled to a partial refund of up to 50% of any advance payment, at Sarwagyna’s discretion, based on work completed.</li>
              <li><strong>Design Phase (Week 3–5):</strong> Refunds are not available once high-fidelity designs have been delivered and approved by the client.</li>
              <li><strong>Development Phase (Week 7+):</strong> No refunds are issued once development work has commenced. You retain all intellectual property for completed deliverables transferred to you.</li>
              <li><strong>Milestone-Based Contracts:</strong> Payments tied to specific milestones are non-refundable once the milestone deliverable has been accepted.</li>
              <li><strong>Cancellation Notice:</strong> Either party may cancel an engagement with 30 days’ written notice. Work completed up to the cancellation date will be invoiced at the agreed rate.</li>
            </ul>
            <p className="text-text-secondary">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-6">
              <li><strong>Consultation and Inquiry Fees:</strong> Fully refundable within 48 hours of payment if no work has commenced.</li>
              <li><strong>Sourcing and Vetting Fees:</strong> Non-refundable once supplier/buyer identification and verification has been initiated.</li>
              <li><strong>Logistics and Customs Fees:</strong> Non-refundable once shipment documentation has been prepared or goods have been dispatched. Disputes related to shipment damage or loss are subject to insurance claims and the terms of the trade agreement.</li>
              <li><strong>Order Cancellation by Client:</strong> If you cancel a confirmed trade order after supplier commitment, you may be liable for cancellation charges as specified in the trade agreement. Sarwagyna will endeavor to minimize these charges.</li>
              <li><strong>Order Cancellation by Sarwagyna:</strong> If Sarwagyna is unable to fulfill a confirmed trade order for reasons within our control, you will receive a full refund of all fees paid.</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-6">
              <li>If an event is cancelled by the organizer, Sarwagyna will initiate a full refund to all ticket purchasers within 7–14 business days.</li>
              <li>If an event is postponed, organizers may offer refund options or credit for the rescheduled event.</li>
              <li>Processing fees (payment gateway charges) are non-refundable in all cases.</li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-4">
              <li><strong>Email:</strong> <a href="mailto:billing@sarwagyna.com" className="text-text hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors">billing@sarwagyna.com</a></li>
              <li><strong>Subject line:</strong> “Refund Request – [Product/Service Name] – [Your Account Email]”</li>
              <li><strong>Include:</strong> Your account details, invoice number, amount paid, date of payment, and reason for the refund request</li>
            </ul>
            <p className="text-text-secondary mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-4">
              <li>Payment gateway processing fees (Razorpay, Stripe, UPI charges)</li>
              <li>GST paid on transactions (will appear as a GST credit note where applicable under Indian law)</li>
              <li>Completed and delivered design assets, software modules, or AI models</li>
              <li>Domain registration, hosting setup fees, or third-party tool licensing procured on your behalf</li>
              <li>Trial period accounts converted to paid accounts where the trial was fully utilized</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2">
              ...
              <li><strong>Phone:</strong> +91-XXXXXXXXXX (Mon–Fri, 9AM–6PM IST)</li>
              <li><strong>Address:</strong> Sarwagyna Pvt Ltd, Registered Office, India</li>
              <li><strong>Response time:</strong> Within 2 business days for refund requests</li>
            </ul>
          </section>
