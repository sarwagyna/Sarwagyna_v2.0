        ...
        >
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-6">
              <li>Session management cookies (maintain your login state across pages)</li>
              <li>Security cookies (protect against CSRF and other attacks)</li>
              <li>Load balancing cookies (ensure stable service delivery)</li>
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-4">
              ...
              <li>Mixpanel (product analytics for SarwHub, SarwCal, SarwBill)</li>
              <li>Internal session recording (scroll depth, CTA engagement — used only in aggregate form)</li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-4">
              ...
              <li>UI preference cookies (dark/light mode, regional settings)</li>
              <li>Form auto-save cookies (for multi-step forms)</li>
            </ul>
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-4">
              <li>LinkedIn Insight Tag (for LinkedIn campaign measurement)</li>
              <li>Google Ads conversion cookies</li>
              <li>Meta Pixel (Facebook/Instagram retargeting)</li>
            </ul>
            <p className="text-text-secondary">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-4">
              <li><strong>Session cookies:</strong> Last for the duration of your browsing session</li>
              <li><strong>Short-term persistent cookies:</strong> 7–30 days (e.g., login state, preferences)</li>
              <li><strong>Long-term analytics cookies:</strong> Up to 13 months (Google Analytics default)</li>
              <li><strong>Marketing cookies:</strong> Up to 90 days (vary by provider)</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-4">
              <li><strong>Google LLC (Analytics, Ads):</strong> <a href="https://policies.google.com/privacy" className="text-text hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors" target="_blank" rel="noopener noreferrer">policies.google.com/privacy</a></li>
              <li><strong>Meta Platforms Ireland Ltd (Facebook/Instagram Pixel):</strong> <a href="https://facebook.com/privacy/policy" className="text-text hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors" target="_blank" rel="noopener noreferrer">facebook.com/privacy/policy</a></li>
              <li><strong>LinkedIn Ireland Unlimited Company (Insight Tag):</strong> <a href="https://linkedin.com/legal/privacy-policy" className="text-text hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors" target="_blank" rel="noopener noreferrer">linkedin.com/legal/privacy-policy</a></li>
              <li><strong>Mixpanel Inc:</strong> <a href="https://mixpanel.com/legal/privacy-policy" className="text-text hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors" target="_blank" rel="noopener noreferrer">mixpanel.com/legal/privacy-policy</a></li>
              <li><strong>Razorpay Software Pvt Ltd (payment processing):</strong> <a href="https://razorpay.com/privacy" className="text-text hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors" target="_blank" rel="noopener noreferrer">razorpay.com/privacy</a></li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2 mb-4">
              <li><strong>Google Analytics:</strong> <a href="https://tools.google.com/dlpage/gaoptout" className="text-text hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors" target="_blank" rel="noopener noreferrer">tools.google.com/dlpage/gaoptout</a></li>
              <li><strong>Network Advertising Initiative:</strong> <a href="https://optout.networkadvertising.org" className="text-text hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors" target="_blank" rel="noopener noreferrer">optout.networkadvertising.org</a></li>
              <li><strong>Your Online Choices (EU):</strong> <a href="https://youronlinechoices.eu" className="text-text hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors" target="_blank" rel="noopener noreferrer">youronlinechoices.eu</a></li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-text-secondary space-y-2">
              <li><strong>Email:</strong> <a href="mailto:privacy@sarwagyna.com" className="text-text hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors">privacy@sarwagyna.com</a></li>
