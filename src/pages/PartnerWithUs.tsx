  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section id="contact-form" className="py-[120px] max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="glass-panel rounded-3xl p-8 md:p-16 border-t border-t-border-subtle">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-4xl font-display font-bold text-text mb-4">Start a Conversation</h2>
            <p className="text-text-secondary">Tell us about your business and how you'd like to partner with Sarwagyna. Our partnership team will get back to you within 48 hours.</p>
          </div>
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto" onSubmit={handleSubmit} noValidate>
            <div className="space-y-2">
              ...
              <input name="fullName" value={form.fullName} onChange={handleChange} required type="text" placeholder="John Doe" className="w-full bg-bg/5 border border-border-subtle rounded-xl px-4 py-3 text-text focus:outline-none focus:border-border-subtle/30 transition-colors" />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium text-text-secondary ml-1">Company Email</label>
              <input name="email" value={form.email} onChange={handleChange} required type="email" placeholder="john@company.com" className="w-full bg-bg/5 border border-border-subtle rounded-xl px-4 py-3 text-text focus:outline-none focus:border-border-subtle/30 transition-colors" />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium text-text-secondary ml-1">Company Name</label>
              <input name="companyName" value={form.companyName} onChange={handleChange} required type="text" placeholder="Acme Inc." className="w-full bg-bg/5 border border-border-subtle rounded-xl px-4 py-3 text-text focus:outline-none focus:border-border-subtle/30 transition-colors" />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium text-text-secondary ml-1">Partnership Type</label>
              <select name="partnershipType" value={form.partnershipType} onChange={handleChange} required className="w-full bg-bg/5 border border-border-subtle rounded-xl px-4 py-3 text-text focus:outline-none focus:border-border-subtle/30 transition-colors appearance-none">
            ...
            <div className="md:col-span-2 space-y-2">
              <label className="text-sm font-medium text-text-secondary ml-1">Message / Proposal</label>
              <textarea name="message" value={form.message} onChange={handleChange} required rows={4} placeholder="Briefly describe your partnership idea..." className="w-full bg-bg/5 border border-border-subtle rounded-xl px-4 py-3 text-text focus:outline-none focus:border-border-subtle/30 transition-colors resize-none"></textarea>
            </div>
